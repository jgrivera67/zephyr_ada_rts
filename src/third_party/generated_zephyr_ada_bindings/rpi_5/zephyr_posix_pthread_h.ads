...
package zephyr_posix_pthread_h is
  ...
  --  
   ...
   function pthread_condattr_getclock (att : access constant zephyr_posix_posix_types_h.pthread_condattr; clock_id : access sys_types_h.clockid_t) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/posix/pthread.h:132
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function pthread_condattr_setclock (att : access zephyr_posix_posix_types_h.pthread_condattr; clock_id : sys_types_h.clockid_t) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/posix/pthread.h:142
   with Import => True, 
        Convention => C, 
