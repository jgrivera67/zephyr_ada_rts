...
package zephyr_kernel_h is
   ...
   --    SYS_TIMEOUT_MS((thread).init_delay_ms)
  ...
  --
   ...
   type u_static_thread_data is record
      ...
      init_delay_ms : aliased sys_ustdint_h.int32_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:763
   end record
  ...
  --
   ...
   type anon_union2862 (discr : unsigned := 0) is record
      case discr is
         when 0 =>
   ...
   type k_work_sync is record
      anon7346 : aliased anon_union2862;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4188
   end record
  ...
  --
   ...
   type anon_union2966 (discr : unsigned := 0) is record
      case discr is
         when 0 =>
   ...
   type k_poll_event is record
      ...
      anon7666 : aliased anon_union2966;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6099
   end record
   with Convention => C_Pass_By_Copy,
        --Pack => True, --  *** FIX ***
        Alignment => 8;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6065
