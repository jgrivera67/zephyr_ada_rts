...
package zephyr_arch_riscv_arch_h is
   ...
   ARCH_STACK_PTR_ALIGN : constant := 16;  --  /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/arch/riscv/arch.h:34
   --  unsupported macro: Z_RISCV_STACK_PMP_ALIGN MAX(CONFIG_PMP_GRANULARITY, ARCH_STACK_PTR_ALIGN)

   Z_RISCV_STACK_GUARD_SIZE : constant := 0;  --  /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/arch/riscv/arch.h:76
   ...
   RV_REGSIZE : constant := 4;  --  /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/arch/riscv/arch.h:152
   RV_REGSHIFT : constant := 2;  --  /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/arch/riscv/arch.h:153

   MSTATUS_IEN : constant := (2 ** 3);  --  /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/arch/riscv/arch.h:160
   --  unsupported macro: MSTATUS_MPP_M (3UL << 11)

   MSTATUS_MPIE_EN : constant := (2 ** 7);  --  /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/arch/riscv/arch.h:162
   --  unsupported macro: MSTATUS_FS_OFF (0UL << 13)

   MSTATUS_FS_INIT : constant := (2 ** 13);  --  /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/arch/riscv/arch.h:165
  ...
  -- Typedef for the k_mem_partition attribute  
   type k_mem_partition_attr_t is record
      pmp_attr : aliased sys_ustdint_h.uint8_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/arch/riscv/arch.h:221
   end record
   with Convention => C_Pass_By_Copy;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/arch/riscv/arch.h:222

   type arch_mem_domain is record
      pmp_update_nr : aliased unsigned;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/arch/riscv/arch.h:225
   end record
   ...
   procedure z_irq_spurious (unused : System.Address)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/arch/riscv/arch.h:228
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function arch_irq_lock return unsigned  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/arch/riscv/arch.h:234
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure arch_irq_unlock (key : unsigned)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/arch/riscv/arch.h:254
   with Import => True, 
        Convention => C, 
        External_Name => "arch_irq_unlock";

   function arch_irq_unlocked (key : unsigned) return Extensions.bool  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/arch/riscv/arch.h:266
   with Import => True, 
        Convention => C, 
        External_Name => "arch_irq_unlocked";

   procedure arch_nop  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/arch/riscv/arch.h:275
   with Import => True, 
        Convention => C, 
        External_Name => "arch_nop";

   function sys_clock_cycle_get_32 return sys_ustdint_h.uint32_t  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/arch/riscv/arch.h:280
   with Import => True, 
        Convention => C, 
        External_Name => "sys_clock_cycle_get_32";

   function arch_k_cycle_get_32 return sys_ustdint_h.uint32_t  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/arch/riscv/arch.h:282
   with Import => True, 
        Convention => C, 
        External_Name => "arch_k_cycle_get_32";

   function sys_clock_cycle_get_64 return sys_ustdint_h.uint64_t  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/arch/riscv/arch.h:287
   with Import => True, 
        Convention => C, 
        External_Name => "sys_clock_cycle_get_64";

   function arch_k_cycle_get_64 return sys_ustdint_h.uint64_t  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/arch/riscv/arch.h:289
   with Import => True, 
        Convention => C, 
