...
package zephyr_fatal_h is
  ...
  --  
   ...
   procedure k_sys_fatal_error_handler (reason : unsigned; esf : access constant zephyr_arch_arm64_exception_h.arch_esf)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/fatal.h:68
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure z_fatal_error (reason : unsigned; esf : access constant zephyr_arch_arm64_exception_h.arch_esf)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/fatal.h:84
   with Import => True, 
        Convention => C, 
