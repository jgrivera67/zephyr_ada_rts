...
package zephyr_sw_isr_table_h is
  ...
  --* IRQ line number  
   subtype anon_array1628 is Interfaces.C.char_array (0 .. 0);
   type u_isr_list_sname is record
      ...
      sname : aliased anon_array1628;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/sw_isr_table.h:165
   end record
  ...
  --  
   ...
   procedure z_isr_install
     (irq : unsigned;
      ...
      param : System.Address)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/sw_isr_table.h:288
   with Import => True, 
        Convention => C, 
