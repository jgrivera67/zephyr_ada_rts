...
package zephyr_app_memory_mem_domain_h is
  ...
  --  
   ...
   function k_mem_domain_init
     (domain : access zephyr_arch_arch_interface_h.k_mem_domain;
      ...
      parts : System.Address) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/app_memory/mem_domain.h:131
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function k_mem_domain_add_partition (domain : access zephyr_arch_arch_interface_h.k_mem_domain; part : access k_mem_partition) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/app_memory/mem_domain.h:161
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function k_mem_domain_remove_partition (domain : access zephyr_arch_arch_interface_h.k_mem_domain; part : access k_mem_partition) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/app_memory/mem_domain.h:176
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function k_mem_domain_add_thread (domain : access zephyr_arch_arch_interface_h.k_mem_domain; thread : zephyr_kernel_thread_h.k_tid_t) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/app_memory/mem_domain.h:190
   with Import => True, 
        Convention => C, 
