...
package zephyr_kernel_internal_mm_h is
   ...
   K_MEM_VIRT_OFFSET : constant := 0;  --  /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel/internal/mm.h:44
   --  arg-macro: function IS_SRAM_ADDRESS_LOWER (ADDR)
   --    return (ADDR) >= CONFIG_SRAM_BASE_ADDRESS;
   --  arg-macro: function IS_SRAM_ADDRESS_UPPER (ADDR)
   --    return (ADDR) < (CONFIG_SRAM_BASE_ADDRESS + (CONFIG_SRAM_SIZE * 1024));
   --  arg-macro: function IS_SRAM_ADDRESS (ADDR)
   --    return IS_SRAM_ADDRESS_LOWER(ADDR)  and then  IS_SRAM_ADDRESS_UPPER(ADDR);
  ...
  --  
   ...
   function k_mem_phys_addr (virt : System.Address) return sys_ustdint_h.uintptr_t  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel/internal/mm.h:116
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function k_mem_virt_addr (phys : sys_ustdint_h.uintptr_t) return System.Address  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel/internal/mm.h:160
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure k_mem_map_phys_bare
     (virt_ptr : System.Address;
      ...
      flags : sys_ustdint_h.uint32_t)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel/internal/mm.h:225
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure k_mem_unmap_phys_bare (virt : access sys_ustdint_h.uint8_t; size : stddef_h.size_t)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel/internal/mm.h:255
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function k_mem_map_phys_guard
     (phys : sys_ustdint_h.uintptr_t;
      ...
      is_anon : Extensions.bool) return System.Address  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel/internal/mm.h:305
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure k_mem_unmap_phys_guard
     (addr : System.Address;
      size : stddef_h.size_t;
      is_anon : Extensions.bool)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel/internal/mm.h:325
   with Import => True, 
        Convention => C, 
