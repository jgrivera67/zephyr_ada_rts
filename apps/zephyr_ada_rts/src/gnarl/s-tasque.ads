...
--  Entry call queue management for Jorvik/Zephyr runtime.
--  FIFO queuing policy. Single-CPU variant (no SMP complexity).
...
package System.Tasking.Queuing is
   ...
   --  Enqueue Call at the end of entry queue E (FIFO)
   ...
   --  Select an entry of a protected object whose barrier is open
