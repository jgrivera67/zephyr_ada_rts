...
package zephyr_kernel_h is
   ...
   --    return -(CONFIG_NUM_COOP_PRIORITIES - (x));
   --  arg-macro: function K_PRIO_PREEMPT (x)
   --    return x;
   --  unsupported macro: K_HIGHEST_THREAD_PRIO (-CONFIG_NUM_COOP_PRIORITIES)
   --  unsupported macro: K_LOWEST_THREAD_PRIO CONFIG_NUM_PREEMPT_PRIORITIES
   --  unsupported macro: K_IDLE_PRIO K_LOWEST_THREAD_PRIO
   --  unsupported macro: K_HIGHEST_APPLICATION_THREAD_PRIO (K_HIGHEST_THREAD_PRIO)
   --  unsupported macro: K_LOWEST_APPLICATION_THREAD_PRIO (K_LOWEST_THREAD_PRIO - 1)
   --  arg-macro: procedure Z_POLL_EVENT_OBJ_INIT (obj)
   --    .poll_events := SYS_DLIST_STATIC_INIT(andobj.poll_events),
   --  unsupported macro: Z_DECL_POLL_EVENT sys_dlist_t poll_events;
   --  unsupported macro: K_ESSENTIAL (BIT(0))
   K_FP_IDX : constant := 1;  --  /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:275
   --  unsupported macro: K_FP_REGS (BIT(K_FP_IDX))
   --  unsupported macro: K_USER (BIT(2))
   --  unsupported macro: K_INHERIT_PERMS (BIT(3))
   --  unsupported macro: K_CALLBACK_STATE (BIT(4))

   K_DSP_IDX : constant := 13;  --  /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:325
   --  unsupported macro: K_DSP_REGS (BIT(K_DSP_IDX))

   K_AGU_IDX : constant := 14;  --  /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:336
   --  unsupported macro: K_AGU_REGS (BIT(K_AGU_IDX))
   --  unsupported macro: K_SSE_REGS (BIT(15))
   --  unsupported macro: k_thread_access_grant(thread,...) FOR_EACH_FIXED_ARG(k_object_access_grant, (;), (thread), __VA_ARGS__)
   --  arg-macro: procedure Z_THREAD_INIT_DELAY_INITIALIZER (ms)
   --    .init_delay := SYS_TIMEOUT_MS_INIT(ms)
   --  arg-macro: procedure Z_THREAD_INIT_DELAY (thread)
   --    (thread).init_delay
   --  arg-macro: procedure Z_THREAD_INITIALIZER (thread, stack, stack_size, entry, p1, p2, p3, prio, options, delay, tname)
   --    { .init_thread := (thread), .init_stack := (stack), .init_stack_size := (stack_size), .init_entry := (k_thread_entry_t)entry, .init_p1 := (void *)p1, .init_p2 := (void *)p2, .init_p3 := (void *)p3, .init_prio := (prio), .init_options := (options), .init_name := STRINGIFY(tname), Z_THREAD_INIT_DELAY_INITIALIZER(delay) }
   --  unsupported macro: Z_THREAD_COMMON_DEFINE(name,stack_size,entry,p1,p2,p3,prio,options,delay) struct k_thread _k_thread_obj_ ##name; const STRUCT_SECTION_ITERABLE(_static_thread_data, _k_thread_data_ ##name) = Z_THREAD_INITIALIZER(&_k_thread_obj_ ##name, _k_thread_stack_ ##name, stack_size, entry, p1, p2, p3, prio, options, delay, name); __maybe_unused const k_tid_t name = (k_tid_t)&_k_thread_obj_ ##name
   --  unsupported macro: K_THREAD_DEFINE(name,stack_size,entry,p1,p2,p3,prio,options,delay) K_THREAD_STACK_DEFINE(_k_thread_stack_ ##name, stack_size); Z_THREAD_COMMON_DEFINE(name, stack_size, entry, p1, p2, p3, prio, options, delay)
   --  unsupported macro: K_KERNEL_THREAD_DEFINE(name,stack_size,entry,p1,p2,p3,prio,options,delay) K_KERNEL_STACK_DEFINE(_k_thread_stack_ ##name, stack_size); Z_THREAD_COMMON_DEFINE(name, stack_size, entry, p1, p2, p3, prio, options, delay)
   --  unsupported macro: K_NO_WAIT Z_TIMEOUT_NO_WAIT
   --  arg-macro: procedure K_NSEC (t)
   --    Z_TIMEOUT_NS(t)
   --  arg-macro: procedure K_USEC (t)
   --    Z_TIMEOUT_US(t)
   --  arg-macro: procedure K_CYC (t)
   --    Z_TIMEOUT_CYC(t)
   --  arg-macro: procedure K_TICKS (t)
   --    Z_TIMEOUT_TICKS(t)
   --  arg-macro: procedure K_MSEC (ms)
   --    Z_TIMEOUT_MS(ms)
   --  arg-macro: procedure K_SECONDS (s)
   --    K_MSEC((s) * MSEC_PER_SEC)
   --  arg-macro: procedure K_MINUTES (m)
   --    K_SECONDS((m) * 60)
   --  arg-macro: procedure K_HOURS (h)
   --    K_MINUTES((h) * 60)
   --  unsupported macro: K_FOREVER Z_FOREVER
   --  arg-macro: procedure K_TIMEOUT_SUM (timeout1, timeout2)
   --    K_TICKS(z_timeout_sum(timeout1, timeout2))
   --  arg-macro: procedure K_TIMEOUT_ABS_TICKS (t)
   --    Z_TIMEOUT_TICKS(Z_TICK_ABS((k_ticks_t)CLAMP(t, 0, (INT64_MAX - 1))))
   --  arg-macro: procedure K_TIMEOUT_ABS_SEC (t)
   --    K_TIMEOUT_ABS_TICKS(k_sec_to_ticks_ceil64(t))
   --  arg-macro: procedure K_TIMEOUT_ABS_MS (t)
   --    K_TIMEOUT_ABS_TICKS(k_ms_to_ticks_ceil64(t))
   --  arg-macro: procedure K_TIMEOUT_ABS_US (t)
   --    K_TIMEOUT_ABS_TICKS(k_us_to_ticks_ceil64(t))
   --  arg-macro: procedure K_TIMEOUT_ABS_NS (t)
   --    K_TIMEOUT_ABS_TICKS(k_ns_to_ticks_ceil64(t))
   --  arg-macro: procedure K_TIMEOUT_ABS_CYC (t)
   --    K_TIMEOUT_ABS_TICKS(k_cyc_to_ticks_ceil64(t))
   --  arg-macro: procedure Z_TIMER_INITIALIZER (obj, expiry, stop)
   --    { .timeout := { .node := {}, .fn := z_timer_expiration_handler, .dticks := 0, }, .wait_q := Z_WAIT_Q_INIT(andobj.wait_q), .expiry_fn := expiry, .stop_fn := stop, .period := {}, .status := 0, .user_data := 0, }
   --  arg-macro: procedure K_TIMER_DEFINE (name, expiry_fn, stop_fn)
   --    STRUCT_SECTION_ITERABLE(k_timer, name) := Z_TIMER_INITIALIZER(name, expiry_fn, stop_fn)
   --  arg-macro: procedure Z_QUEUE_INITIALIZER (obj)
   --    { .data_q := SYS_SFLIST_STATIC_INIT(andobj.data_q), .lock := { }, .wait_q := Z_WAIT_Q_INIT(andobj.wait_q), Z_POLL_EVENT_OBJ_INIT(obj) }
   --  arg-macro: procedure K_QUEUE_DEFINE (name)
   --    STRUCT_SECTION_ITERABLE(k_queue, name) := Z_QUEUE_INITIALIZER(name)
   --  arg-macro: procedure Z_EVENT_INITIALIZER (obj)
   --    { .wait_q := Z_WAIT_Q_INIT(andobj.wait_q), .events := 0, .lock := {}, }
   --  arg-macro: procedure K_EVENT_DEFINE (name)
   --    STRUCT_SECTION_ITERABLE(k_event, name) := Z_EVENT_INITIALIZER(name);
   --  arg-macro: procedure Z_FIFO_INITIALIZER (obj)
   --    { ._queue := Z_QUEUE_INITIALIZER(obj._queue) }
   --  arg-macro: function k_fifo_init (fifo)
   --    return { SYS_PORT_TRACING_OBJ_FUNC_ENTER(k_fifo, init, fifo); k_queue_init(and(fifo)._queue); K_OBJ_CORE_INIT(K_OBJ_CORE(fifo), _obj_type_fifo); K_OBJ_CORE_LINK(K_OBJ_CORE(fifo)); SYS_PORT_TRACING_OBJ_FUNC_EXIT(k_fifo, init, fifo); };
   --  arg-macro: function k_fifo_cancel_wait (fifo)
   --    return { SYS_PORT_TRACING_OBJ_FUNC_ENTER(k_fifo, cancel_wait, fifo); k_queue_cancel_wait(and(fifo)._queue); SYS_PORT_TRACING_OBJ_FUNC_EXIT(k_fifo, cancel_wait, fifo); };
   --  arg-macro: function k_fifo_put (fifo, data)
   --    return { void *_data := data; SYS_PORT_TRACING_OBJ_FUNC_ENTER(k_fifo, put, fifo, _data); k_queue_append(and(fifo)._queue, _data); SYS_PORT_TRACING_OBJ_FUNC_EXIT(k_fifo, put, fifo, _data); };
   --  arg-macro: function k_fifo_alloc_put (fifo, data)
   --    return { void *_data := data; SYS_PORT_TRACING_OBJ_FUNC_ENTER(k_fifo, alloc_put, fifo, _data); int fap_ret := k_queue_alloc_append(and(fifo)._queue, _data); SYS_PORT_TRACING_OBJ_FUNC_EXIT(k_fifo, alloc_put, fifo, _data, fap_ret); fap_ret; };
   --  arg-macro: function k_fifo_put_list (fifo, head, tail)
   --    return { SYS_PORT_TRACING_OBJ_FUNC_ENTER(k_fifo, put_list, fifo, head, tail); k_queue_append_list(and(fifo)._queue, head, tail); SYS_PORT_TRACING_OBJ_FUNC_EXIT(k_fifo, put_list, fifo, head, tail); };
   --  arg-macro: function k_fifo_put_slist (fifo, list)
   --    return { SYS_PORT_TRACING_OBJ_FUNC_ENTER(k_fifo, put_slist, fifo, list); k_queue_merge_slist(and(fifo)._queue, list); SYS_PORT_TRACING_OBJ_FUNC_EXIT(k_fifo, put_slist, fifo, list); };
   --  arg-macro: function k_fifo_get (fifo, timeout)
   --    return { SYS_PORT_TRACING_OBJ_FUNC_ENTER(k_fifo, get, fifo, timeout); void *fg_ret := k_queue_get(and(fifo)._queue, timeout); SYS_PORT_TRACING_OBJ_FUNC_EXIT(k_fifo, get, fifo, timeout, fg_ret); fg_ret; };
   --  arg-macro: procedure k_fifo_is_empty (fifo)
   --    k_queue_is_empty(and(fifo)._queue)
   --  arg-macro: function k_fifo_peek_head (fifo)
   --    return { SYS_PORT_TRACING_OBJ_FUNC_ENTER(k_fifo, peek_head, fifo); void *fph_ret := k_queue_peek_head(and(fifo)._queue); SYS_PORT_TRACING_OBJ_FUNC_EXIT(k_fifo, peek_head, fifo, fph_ret); fph_ret; };
   --  arg-macro: function k_fifo_peek_tail (fifo)
   --    return { SYS_PORT_TRACING_OBJ_FUNC_ENTER(k_fifo, peek_tail, fifo); void *fpt_ret := k_queue_peek_tail(and(fifo)._queue); SYS_PORT_TRACING_OBJ_FUNC_EXIT(k_fifo, peek_tail, fifo, fpt_ret); fpt_ret; };
   --  arg-macro: procedure K_FIFO_DEFINE (name)
   --    STRUCT_SECTION_ITERABLE(k_fifo, name) := Z_FIFO_INITIALIZER(name)
   --  arg-macro: procedure Z_LIFO_INITIALIZER (obj)
   --    { ._queue := Z_QUEUE_INITIALIZER(obj._queue) }
   --  arg-macro: function k_lifo_init (lifo)
   --    return { SYS_PORT_TRACING_OBJ_FUNC_ENTER(k_lifo, init, lifo); k_queue_init(and(lifo)._queue); K_OBJ_CORE_INIT(K_OBJ_CORE(lifo), _obj_type_lifo); K_OBJ_CORE_LINK(K_OBJ_CORE(lifo)); SYS_PORT_TRACING_OBJ_FUNC_EXIT(k_lifo, init, lifo); };
   --  arg-macro: function k_lifo_put (lifo, data)
   --    return { void *_data := data; SYS_PORT_TRACING_OBJ_FUNC_ENTER(k_lifo, put, lifo, _data); k_queue_prepend(and(lifo)._queue, _data); SYS_PORT_TRACING_OBJ_FUNC_EXIT(k_lifo, put, lifo, _data); };
   --  arg-macro: function k_lifo_alloc_put (lifo, data)
   --    return { void *_data := data; SYS_PORT_TRACING_OBJ_FUNC_ENTER(k_lifo, alloc_put, lifo, _data); int lap_ret := k_queue_alloc_prepend(and(lifo)._queue, _data); SYS_PORT_TRACING_OBJ_FUNC_EXIT(k_lifo, alloc_put, lifo, _data, lap_ret); lap_ret; };
   --  arg-macro: function k_lifo_get (lifo, timeout)
   --    return { SYS_PORT_TRACING_OBJ_FUNC_ENTER(k_lifo, get, lifo, timeout); void *lg_ret := k_queue_get(and(lifo)._queue, timeout); SYS_PORT_TRACING_OBJ_FUNC_EXIT(k_lifo, get, lifo, timeout, lg_ret); lg_ret; };
   --  arg-macro: procedure K_LIFO_DEFINE (name)
   --    STRUCT_SECTION_ITERABLE(k_lifo, name) := Z_LIFO_INITIALIZER(name)
   --  unsupported macro: K_STACK_FLAG_ALLOC ((uint8_t)1)
   --  arg-macro: procedure Z_STACK_INITIALIZER (obj, stack_buffer, stack_num_entries)
   --    { .wait_q := Z_WAIT_Q_INIT(and(obj).wait_q), .base := (stack_buffer), .next := (stack_buffer), .top := (stack_buffer) + (stack_num_entries), }
   --  unsupported macro: K_STACK_DEFINE(name,stack_num_entries) stack_data_t __noinit _k_stack_buf_ ##name[stack_num_entries]; STRUCT_SECTION_ITERABLE(k_stack, name) = Z_STACK_INITIALIZER(name, _k_stack_buf_ ##name, stack_num_entries)
   --  arg-macro: procedure Z_MUTEX_INITIALIZER (obj)
   --    { .wait_q := Z_WAIT_Q_INIT(and(obj).wait_q), .owner := NULL, .lock_count := 0, .owner_orig_prio := K_LOWEST_APPLICATION_THREAD_PRIO, }
   --  arg-macro: procedure K_MUTEX_DEFINE (name)
   --    STRUCT_SECTION_ITERABLE(k_mutex, name) := Z_MUTEX_INITIALIZER(name)
   --  arg-macro: procedure Z_CONDVAR_INITIALIZER (obj)
   --    { .wait_q := Z_WAIT_Q_INIT(andobj.wait_q), }
   --  arg-macro: procedure K_CONDVAR_DEFINE (name)
   --    STRUCT_SECTION_ITERABLE(k_condvar, name) := Z_CONDVAR_INITIALIZER(name)
   --  arg-macro: procedure Z_SEM_INITIALIZER (obj, initial_count, count_limit)
   --    { .wait_q := Z_WAIT_Q_INIT(and(obj).wait_q), .count := (initial_count), .limit := (count_limit), Z_POLL_EVENT_OBJ_INIT(obj) }
   --  unsupported macro: K_SEM_MAX_LIMIT UINT_MAX
   --  arg-macro: procedure K_SEM_DEFINE (name, initial_count, count_limit)
   --    STRUCT_SECTION_ITERABLE(k_sem, name) := Z_SEM_INITIALIZER(name, initial_count, count_limit); BUILD_ASSERT(((count_limit) /= 0)  and then  (((initial_count) < (count_limit))  or else  ((initial_count) = (count_limit)))  and then  ((count_limit) <= K_SEM_MAX_LIMIT));
   --  arg-macro: procedure Z_WORK_INITIALIZER (work_handler)
   --    { .handler := (work_handler), }
   --  arg-macro: procedure Z_WORK_DELAYABLE_INITIALIZER (work_handler)
   --    { .work := { .handler := (work_handler), .flags := K_WORK_DELAYABLE, }, }
   --  arg-macro: procedure K_WORK_DELAYABLE_DEFINE (work, work_handler)
   --    struct k_work_delayable work := Z_WORK_DELAYABLE_INITIALIZER(work_handler)
   --  arg-macro: procedure Z_WORK_USER_INITIALIZER (work_handler)
   --    { ._reserved := NULL, .handler := (work_handler), .flags := 0 }
   --  arg-macro: procedure K_WORK_USER_DEFINE (work, work_handler)
   --    struct k_work_user work := Z_WORK_USER_INITIALIZER(work_handler)
   --  arg-macro: procedure K_WORK_DEFINE (work, work_handler)
   --    struct k_work work := Z_WORK_INITIALIZER(work_handler)
   --  arg-macro: procedure Z_MSGQ_INITIALIZER (obj, q_buffer, q_msg_size, q_max_msgs)
   --    { .wait_q := Z_WAIT_Q_INIT(andobj.wait_q), .lock := {}, .msg_size := q_msg_size, .max_msgs := q_max_msgs, .buffer_start := q_buffer, .buffer_end := q_buffer + (q_max_msgs * q_msg_size), .read_ptr := q_buffer, .write_ptr := q_buffer, .used_msgs := 0, Z_POLL_EVENT_OBJ_INIT(obj) .flags := 0, }
   --  unsupported macro: K_MSGQ_FLAG_ALLOC BIT(0)
   --  unsupported macro: K_MSGQ_DEFINE(q_name,q_msg_size,q_max_msgs,q_align) static char __noinit __aligned(q_align) _k_fifo_buf_ ##q_name[(q_max_msgs) * (q_msg_size)]; STRUCT_SECTION_ITERABLE(k_msgq, q_name) = Z_MSGQ_INITIALIZER(q_name, _k_fifo_buf_ ##q_name, (q_msg_size), (q_max_msgs))
   --  arg-macro: procedure Z_MBOX_INITIALIZER (obj)
   --    { .tx_msg_queue := Z_WAIT_Q_INIT(andobj.tx_msg_queue), .rx_msg_queue := Z_WAIT_Q_INIT(andobj.rx_msg_queue), }
   --  arg-macro: procedure K_MBOX_DEFINE (name)
   --    STRUCT_SECTION_ITERABLE(k_mbox, name) := Z_MBOX_INITIALIZER(name)
   --  arg-macro: procedure Z_PIPE_INITIALIZER (obj, pipe_buffer, pipe_buffer_size)
   --    { .waiting := 0, .buf := RING_BUF_INIT(pipe_buffer, pipe_buffer_size), .data := Z_WAIT_Q_INIT(andobj.data), .space := Z_WAIT_Q_INIT(andobj.space), .flags := PIPE_FLAG_OPEN, Z_POLL_EVENT_OBJ_INIT(obj) }
   --  unsupported macro: K_PIPE_DEFINE(name,pipe_buffer_size,pipe_align) static unsigned char __noinit __aligned(pipe_align) _k_pipe_buf_ ##name[pipe_buffer_size]; STRUCT_SECTION_ITERABLE(k_pipe, name) = Z_PIPE_INITIALIZER(name, _k_pipe_buf_ ##name, pipe_buffer_size)
   --  arg-macro: procedure Z_MEM_SLAB_INITIALIZER (_slab, _slab_buffer, _slab_block_size, _slab_num_blocks)
   --    { .wait_q := Z_WAIT_Q_INIT(and(_slab).wait_q), .lock := {}, .buffer := _slab_buffer, .free_list := NULL, .info := {_slab_num_blocks, _slab_block_size, 0} }
   --  unsupported macro: K_MEM_SLAB_DEFINE_IN_SECT(name,in_section,slab_block_size,slab_num_blocks,slab_align) BUILD_ASSERT(((slab_block_size) % (slab_align)) == 0, "slab_block_size must be a multiple of slab_align"); BUILD_ASSERT((((slab_align) & ((slab_align) - 1)) == 0), "slab_align must be a power of 2"); char in_section __aligned(WB_UP( slab_align)) _k_mem_slab_buf_ ##name[(slab_num_blocks) * WB_UP(slab_block_size)]; STRUCT_SECTION_ITERABLE(k_mem_slab, name) = Z_MEM_SLAB_INITIALIZER( name, _k_mem_slab_buf_ ##name, WB_UP(slab_block_size), slab_num_blocks)
   --  unsupported macro: K_MEM_SLAB_DEFINE(name,slab_block_size,slab_num_blocks,slab_align) K_MEM_SLAB_DEFINE_IN_SECT(name, __noinit_named(k_mem_slab_buf_ ##name), slab_block_size, slab_num_blocks, slab_align)
   --  unsupported macro: K_MEM_SLAB_DEFINE_IN_SECT_STATIC(name,in_section,slab_block_size,slab_num_blocks,slab_align) BUILD_ASSERT(((slab_block_size) % (slab_align)) == 0, "slab_block_size must be a multiple of slab_align"); BUILD_ASSERT((((slab_align) & ((slab_align) - 1)) == 0), "slab_align must be a power of 2"); static char in_section __aligned(WB_UP( slab_align)) _k_mem_slab_buf_ ##name[(slab_num_blocks) * WB_UP(slab_block_size)]; static STRUCT_SECTION_ITERABLE(k_mem_slab, name) = Z_MEM_SLAB_INITIALIZER( name, _k_mem_slab_buf_ ##name, WB_UP(slab_block_size), slab_num_blocks)
   --  unsupported macro: K_MEM_SLAB_DEFINE_STATIC(name,slab_block_size,slab_num_blocks,slab_align) K_MEM_SLAB_DEFINE_IN_SECT_STATIC(name, __noinit_named(k_mem_slab_buf_ ##name), slab_block_size, slab_num_blocks, slab_align)
   --  unsupported macro: Z_HEAP_MIN_SIZE ((sizeof(void *) > 4) ? 56 : 44)
   --  unsupported macro: Z_HEAP_DEFINE_IN_SECT(name,bytes,in_section) char in_section __aligned(8) kheap_ ##name[MAX(bytes, Z_HEAP_MIN_SIZE)]; STRUCT_SECTION_ITERABLE(k_heap, name) = { .heap = { .init_mem = kheap_ ##name, .init_bytes = MAX(bytes, Z_HEAP_MIN_SIZE), }, }
   --  unsupported macro: K_HEAP_DEFINE(name,bytes) Z_HEAP_DEFINE_IN_SECT(name, bytes, __noinit_named(kheap_buf_ ##name))
   --  arg-macro: procedure K_HEAP_DEFINE_NOCACHE (name, bytes)
   --    Z_HEAP_DEFINE_IN_SECT(name, bytes, __nocache)
   --  arg-macro: function Z_POLL_TYPE_BIT (type)
   --    return 2 ** ((type) - 1);
   --  arg-macro: function Z_POLL_STATE_BIT (state)
   --    return 2 ** ((state) - 1);

   K_POLL_TYPE_IGNORE : constant := 0;  --  /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6368
   --  unsupported macro: K_POLL_TYPE_SIGNAL Z_POLL_TYPE_BIT(_POLL_TYPE_SIGNAL)
   --  unsupported macro: K_POLL_TYPE_SEM_AVAILABLE Z_POLL_TYPE_BIT(_POLL_TYPE_SEM_AVAILABLE)
   --  unsupported macro: K_POLL_TYPE_DATA_AVAILABLE Z_POLL_TYPE_BIT(_POLL_TYPE_DATA_AVAILABLE)
   --  unsupported macro: K_POLL_TYPE_FIFO_DATA_AVAILABLE K_POLL_TYPE_DATA_AVAILABLE
   --  unsupported macro: K_POLL_TYPE_MSGQ_DATA_AVAILABLE Z_POLL_TYPE_BIT(_POLL_TYPE_MSGQ_DATA_AVAILABLE)
   --  unsupported macro: K_POLL_TYPE_PIPE_DATA_AVAILABLE Z_POLL_TYPE_BIT(_POLL_TYPE_PIPE_DATA_AVAILABLE)

   K_POLL_STATE_NOT_READY : constant := 0;  --  /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6385
   --  unsupported macro: K_POLL_STATE_SIGNALED Z_POLL_STATE_BIT(_POLL_STATE_SIGNALED)
   --  unsupported macro: K_POLL_STATE_SEM_AVAILABLE Z_POLL_STATE_BIT(_POLL_STATE_SEM_AVAILABLE)
   --  unsupported macro: K_POLL_STATE_DATA_AVAILABLE Z_POLL_STATE_BIT(_POLL_STATE_DATA_AVAILABLE)
   --  unsupported macro: K_POLL_STATE_FIFO_DATA_AVAILABLE K_POLL_STATE_DATA_AVAILABLE
   --  unsupported macro: K_POLL_STATE_MSGQ_DATA_AVAILABLE Z_POLL_STATE_BIT(_POLL_STATE_MSGQ_DATA_AVAILABLE)
   --  unsupported macro: K_POLL_STATE_PIPE_DATA_AVAILABLE Z_POLL_STATE_BIT(_POLL_STATE_PIPE_DATA_AVAILABLE)
   --  unsupported macro: K_POLL_STATE_CANCELLED Z_POLL_STATE_BIT(_POLL_STATE_CANCELLED)
   --  arg-macro: procedure K_POLL_SIGNAL_INITIALIZER (obj)
   --    { .poll_events := SYS_DLIST_STATIC_INIT(andobj.poll_events), .signaled := 0, .result := 0, }
   --  unsupported macro: K_POLL_EVENT_INITIALIZER(_event_type,_event_mode,_event_obj) { .poller = NULL, .type = _event_type, .state = K_POLL_STATE_NOT_READY, .mode = _event_mode, .unused = 0, { .typed_ ##_event_type = _event_obj, }, }
   --  unsupported macro: K_POLL_EVENT_STATIC_INITIALIZER(_event_type,_event_mode,_event_obj,event_tag) { .tag = event_tag, .type = _event_type, .state = K_POLL_STATE_NOT_READY, .mode = _event_mode, .unused = 0, { .typed_ ##_event_type = _event_obj, }, }
   --  arg-macro: procedure z_except_reason (reason)
   --    ARCH_EXCEPT(reason)
   --  arg-macro: procedure k_oops ()
   --    z_except_reason(K_ERR_KERNEL_OOPS)
   --  arg-macro: procedure k_panic ()
  ...
  --
   ...
   type k_futex is null record;   -- incomplete struct

   type execution_context_types is
     (K_ISR,
      K_COOP_THREAD,
      K_PREEMPT_THREAD)
   with Convention => C;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:91

  -- private, used by k_poll and k_work_poll
   type k_poll_event;
   type u_poller_cb_t is access function (arg1 : access k_poll_event; arg2 : sys_ustdint_h.uint32_t) return int
   with Convention => C;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:99
  ...
  --
   ...
   procedure k_thread_runtime_stats_longest_frame_reset (thread : access zephyr_kernel_thread_h.k_thread)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:120
   with Import => True,
        Convention => C,
        External_Name => "k_thread_runtime_stats_longest_frame_reset";

   type k_thread_user_cb_t is access procedure (arg1 : access constant zephyr_kernel_thread_h.k_thread; arg2 : System.Address)
   with Convention => C;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:127
  ...
  --
   ...
   procedure k_thread_foreach (user_cb : k_thread_user_cb_t; user_data : System.Address)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:145
   with Import => True,
        Convention => C,
        External_Name => "k_thread_foreach";
  ...
  --
   ...
   procedure k_thread_foreach_filter_by_cpu
     (cpu : unsigned;
      user_cb : k_thread_user_cb_t;
      user_data : System.Address)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:170
   with Import => True,
        Convention => C,
        External_Name => "k_thread_foreach_filter_by_cpu";
  ...
  --
   ...
   procedure k_thread_foreach_unlocked (user_cb : k_thread_user_cb_t; user_data : System.Address)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:206
   with Import => True,
        Convention => C,
        External_Name => "k_thread_foreach_unlocked";
  ...
  --
   ...
   procedure k_thread_foreach_unlocked_filter_by_cpu
     (cpu : unsigned;
      user_cb : k_thread_user_cb_t;
      user_data : System.Address)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:245
   with Import => True,
        Convention => C,
        External_Name => "k_thread_foreach_unlocked_filter_by_cpu";
  ...
  --
   ...
   procedure k_thread_user_mode_enter
     (c_entry : zephyr_arch_arch_interface_h.k_thread_entry_t;
      p1 : System.Address;
      p2 : System.Address;
      p3 : System.Address)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:472
   with Import => True,
        Convention => C,
        External_Name => "k_thread_user_mode_enter";
  ...
  --
   ...
   type k_heap;
   procedure k_thread_heap_assign (thread : access zephyr_kernel_thread_h.k_thread; heap : access k_heap)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:506
   with Import => True,
        Convention => C,
        External_Name => "k_thread_heap_assign";
  ...
  --
   ...
   type k_thread_stack_safety_handler_t is access procedure
        (arg1 : access constant zephyr_kernel_thread_h.k_thread;
         arg2 : stddef_h.size_t;
         arg3 : System.Address)
   with Convention => C;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:597
  ...
  --
   ...
   function k_thread_runtime_stack_safety_full_check
     (thread : access constant zephyr_kernel_thread_h.k_thread;
      unused_ptr : access stddef_h.size_t;
      handler : k_thread_stack_safety_handler_t;
      arg : System.Address) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:614
   with Import => True,
        Convention => C,
        External_Name => "k_thread_runtime_stack_safety_full_check";
  ...
  --
   ...
   function k_thread_runtime_stack_safety_threshold_check
     (thread : access constant zephyr_kernel_thread_h.k_thread;
      unused_ptr : access stddef_h.size_t;
      handler : k_thread_stack_safety_handler_t;
      arg : System.Address) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:633
   with Import => True,
        Convention => C,
        External_Name => "k_thread_runtime_stack_safety_threshold_check";
  ...
  --
   ...
   procedure k_thread_system_pool_assign (thread : access zephyr_kernel_thread_h.k_thread)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:652
   with Import => True,
        Convention => C,
        External_Name => "k_thread_system_pool_assign";
  ...
  --
   ...
   function k_msleep (ms : sys_ustdint_h.int32_t) return sys_ustdint_h.int32_t  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:702
   with Import => True,
        Convention => C,
        External_Name => "k_msleep";
  ...
  --
   ...
   function k_can_yield return Extensions.bool  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:754
   with Import => True,
        Convention => C,
        External_Name => "k_can_yield";
  ...
  --
   ...
   function k_is_pre_kernel return Extensions.bool  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:803
   with Import => True,
        Convention => C,
        External_Name => "k_is_pre_kernel";

  -- in init.c
   z_sys_post_kernel : aliased Extensions.bool  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:805
   with Import => True,
        Convention => C,
        External_Name => "z_sys_post_kernel";
  ...
  --
   ...
   function k_current_get return zephyr_kernel_thread_h.k_tid_t  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:836
   with Import => True,
        Convention => C,
        External_Name => "k_current_get";

  -- Thread-local cache of current thread ID, set in z_thread_entry()
   z_tls_current : zephyr_kernel_thread_h.k_tid_t  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:843
   with Import => True,
        Convention => C,
        External_Name => "z_tls_current";
  ...
  --
   ...
   function z_timeout_expires (timeout : access constant zephyr_kernel_structs_h.u_timeout) return zephyr_sys_clock_h.k_ticks_t  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:872
   with Import => True,
        Convention => C,
        External_Name => "z_timeout_expires";

   function z_timeout_remaining (timeout : access constant zephyr_kernel_structs_h.u_timeout) return zephyr_sys_clock_h.k_ticks_t  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:873
   with Import => True,
        Convention => C,
        External_Name => "z_timeout_remaining";
  ...
  --
   ...
   function z_impl_k_thread_timeout_expires_ticks (thread : access constant zephyr_kernel_thread_h.k_thread) return zephyr_sys_clock_h.k_ticks_t  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:886
   with Import => True,
        Convention => C,
        External_Name => "z_impl_k_thread_timeout_expires_ticks";
  ...
  --
   ...
   function z_impl_k_thread_timeout_remaining_ticks (thread : access constant zephyr_kernel_thread_h.k_thread) return zephyr_sys_clock_h.k_ticks_t  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:901
   with Import => True,
        Convention => C,
        External_Name => "z_impl_k_thread_timeout_remaining_ticks";

  --*
  -- * @cond INTERNAL_HIDDEN
  --

   type u_static_thread_data is record
      init_thread : access zephyr_kernel_thread_h.k_thread;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:914
      init_stack : access zephyr_kernel_thread_stack_h.z_thread_stack_element;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:915
      init_stack_size : aliased unsigned;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:916
      init_entry : zephyr_arch_arch_interface_h.k_thread_entry_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:917
      init_p1 : System.Address;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:918
      init_p2 : System.Address;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:919
      init_p3 : System.Address;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:920
      init_prio : aliased int;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:921
      init_options : aliased sys_ustdint_h.uint32_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:922
      init_name : Interfaces.C.Strings.chars_ptr;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:923
      init_delay : aliased zephyr_sys_clock_h.k_timeout_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:927
   end record
   with Convention => C_Pass_By_Copy;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:913
  ...
  --
   ...
   function k_thread_cpu_mask_clear (thread : zephyr_kernel_thread_h.k_tid_t) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:1200
   with Import => True,
        Convention => C,
        External_Name => "k_thread_cpu_mask_clear";
  ...
  --
   ...
   function k_thread_cpu_mask_enable_all (thread : zephyr_kernel_thread_h.k_tid_t) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:1214
   with Import => True,
        Convention => C,
        External_Name => "k_thread_cpu_mask_enable_all";
  ...
  --
   ...
   function k_thread_cpu_mask_enable (thread : zephyr_kernel_thread_h.k_tid_t; cpu : int) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:1228
   with Import => True,
        Convention => C,
        External_Name => "k_thread_cpu_mask_enable";
  ...
  --
   ...
   function k_thread_cpu_mask_disable (thread : zephyr_kernel_thread_h.k_tid_t; cpu : int) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:1242
   with Import => True,
        Convention => C,
        External_Name => "k_thread_cpu_mask_disable";
  ...
  --
   ...
   function k_thread_cpu_pin (thread : zephyr_kernel_thread_h.k_tid_t; cpu : int) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:1254
   with Import => True,
        Convention => C,
        External_Name => "k_thread_cpu_pin";
  ...
  --
   ...
   procedure k_thread_start (thread : zephyr_kernel_thread_h.k_tid_t)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:1306
   with Import => True,
        Convention => C,
        External_Name => "k_thread_start";
  ...
  --
   ...
   procedure k_sched_time_slice_set (slice : sys_ustdint_h.int32_t; prio : int)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:1337
   with Import => True,
        Convention => C,
        External_Name => "k_sched_time_slice_set";
  ...
  --
   ...
   procedure k_thread_time_slice_set
     (th : access zephyr_kernel_thread_h.k_thread;
      slice_ticks : sys_ustdint_h.int32_t;
      expired : zephyr_kernel_structs_h.k_thread_timeslice_fn_t;
      data : System.Address)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:1377
   with Import => True,
        Convention => C,
        External_Name => "k_thread_time_slice_set";
  ...
  --
   ...
   function k_is_in_isr return Extensions.bool  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:1398
   with Import => True,
        Convention => C,
        External_Name => "k_is_in_isr";
  ...
  --
   ...
   procedure k_sched_lock  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:1452
   with Import => True,
        Convention => C,
        External_Name => "k_sched_lock";
  ...
  --
   ...
   procedure k_sched_unlock  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:1461
   with Import => True,
        Convention => C,
        External_Name => "k_sched_unlock";
  ...
  --
   ...
   function k_thread_name_get (thread : zephyr_kernel_thread_h.k_tid_t) return Interfaces.C.Strings.chars_ptr  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:1509
   with Import => True,
        Convention => C,
        External_Name => "k_thread_name_get";
  ...
  --
   ...
   function k_thread_state_str
     (thread_id : zephyr_kernel_thread_h.k_tid_t;
      buf : Interfaces.C.Strings.chars_ptr;
      buf_size : stddef_h.size_t) return Interfaces.C.Strings.chars_ptr  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:1537
   with Import => True,
        Convention => C,
        External_Name => "k_thread_state_str";
  ...
  --
   ...
   type k_timer;
   type k_timer is record
      timeout : aliased zephyr_kernel_structs_h.u_timeout;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:1789
      wait_q : aliased zephyr_kernel_structs_h.u_wait_q_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:1792
      expiry_fn : access procedure (arg1 : access k_timer);  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:1795
      stop_fn : access procedure (arg1 : access k_timer);  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:1798
      period : aliased zephyr_sys_clock_h.k_timeout_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:1801
      status : aliased sys_ustdint_h.uint32_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:1804
      user_data : System.Address;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:1807
   end record
   with Convention => C_Pass_By_Copy;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:1779
  ...
  --
   ...
   type k_timer_expiry_t is access procedure (arg1 : access k_timer)
   with Convention => C;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:1874
  ...
  --
   ...
   type k_timer_stop_t is access procedure (arg1 : access k_timer)
   with Convention => C;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:1890
  ...
  --
   ...
   procedure k_timer_init
     (timer : access k_timer;
      expiry_fn : k_timer_expiry_t;
      stop_fn : k_timer_stop_t)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:1952
   with Import => True,
        Convention => C,
        External_Name => "k_timer_init";
  ...
  --
   ...
   function z_impl_k_timer_expires_ticks (timer : access constant k_timer) return zephyr_sys_clock_h.k_ticks_t  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:2041
   with Import => True,
        Convention => C,
        External_Name => "z_impl_k_timer_expires_ticks";
  ...
  --
   ...
   function z_impl_k_timer_remaining_ticks (timer : access constant k_timer) return zephyr_sys_clock_h.k_ticks_t  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:2059
   with Import => True,
        Convention => C,
        External_Name => "z_impl_k_timer_remaining_ticks";
  ...
  --
   ...
   function k_timer_remaining_get (timer : access k_timer) return sys_ustdint_h.uint32_t  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:2075
   with Import => True,
        Convention => C,
        External_Name => "k_timer_remaining_get";
  ...
  --
   ...
   procedure z_impl_k_timer_user_data_set (timer : access k_timer; user_data : System.Address)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:2099
   with Import => True,
        Convention => C,
        External_Name => "z_impl_k_timer_user_data_set";
  ...
  --
   ...
   function z_impl_k_timer_user_data_get (timer : access constant k_timer) return System.Address  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:2114
   with Import => True,
        Convention => C,
        External_Name => "z_impl_k_timer_user_data_get";
  ...
  --
   ...
   function k_uptime_get return sys_ustdint_h.int64_t  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:2151
   with Import => True,
        Convention => C,
        External_Name => "k_uptime_get";
  ...
  --
   ...
   function k_uptime_get_32 return sys_ustdint_h.uint32_t  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:2175
   with Import => True,
        Convention => C,
        External_Name => "k_uptime_get_32";
  ...
  --
   ...
   function k_uptime_seconds return sys_ustdint_h.uint32_t  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:2188
   with Import => True,
        Convention => C,
        External_Name => "k_uptime_seconds";
  ...
  --
   ...
   function k_uptime_delta (reftime : access sys_ustdint_h.int64_t) return sys_ustdint_h.int64_t  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:2204
   with Import => True,
        Convention => C,
        External_Name => "k_uptime_delta";
  ...
  --
   ...
   function k_cycle_get_32 return sys_ustdint_h.uint32_t  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:2223
   with Import => True,
        Convention => C,
        External_Name => "k_cycle_get_32";
  ...
  --
   ...
   function k_cycle_get_64 return sys_ustdint_h.uint64_t  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:2238
   with Import => True,
        Convention => C,
        External_Name => "k_cycle_get_64";

  --*
  -- * @}
  --

   type k_queue is record
      data_q : aliased zephyr_sys_sflist_h.sys_sflist_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:2254
      lock : aliased zephyr_spinlock_h.k_spinlock;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:2255
      wait_q : aliased zephyr_kernel_structs_h.u_wait_q_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:2256
      poll_events : aliased zephyr_sys_dlist_h.sys_dlist_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:2258
   end record
   with Convention => C_Pass_By_Copy;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:2253
  ...
  --
   ...
   procedure k_queue_append (queue : access k_queue; data : System.Address)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:2321
   with Import => True,
        Convention => C,
        External_Name => "k_queue_append";
  ...
  --
   ...
   procedure k_queue_prepend (queue : access k_queue; data : System.Address)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:2353
   with Import => True,
        Convention => C,
        External_Name => "k_queue_prepend";
  ...
  --
   ...
   procedure k_queue_insert
     (queue : access k_queue;
      prev : System.Address;
      data : System.Address)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:2386
   with Import => True,
        Convention => C,
        External_Name => "k_queue_insert";
  ...
  --
   ...
   function k_queue_append_list
     (queue : access k_queue;
      head : System.Address;
      tail : System.Address) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:2406
   with Import => True,
        Convention => C,
        External_Name => "k_queue_append_list";
  ...
  --
   ...
   function k_queue_merge_slist (queue : access k_queue; list : access zephyr_sys_slist_h.u_slist) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:2423
   with Import => True,
        Convention => C,
        External_Name => "k_queue_merge_slist";
  ...
  --
   ...
   function k_queue_remove (queue : access k_queue; data : System.Address) return Extensions.bool  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:2460
   with Import => True,
        Convention => C,
        External_Name => "k_queue_remove";
  ...
  --
   ...
   function k_queue_unique_append (queue : access k_queue; data : System.Address) return Extensions.bool  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:2476
   with Import => True,
        Convention => C,
        External_Name => "k_queue_unique_append";
  ...
  --
   ...
   function z_impl_k_queue_is_empty (queue : access k_queue) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:2493
   with Import => True,
        Convention => C,
        External_Name => "z_impl_k_queue_is_empty";
  ...
  --
   ...
   type k_event is record
      wait_q : aliased zephyr_kernel_structs_h.u_wait_q_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:2635
      events : aliased sys_ustdint_h.uint32_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:2636
      lock : aliased zephyr_spinlock_h.k_spinlock;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:2637
   end record
   with Convention => C_Pass_By_Copy;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:2631
  ...
  --
   ...
   function k_event_test (event : access k_event; events_mask : sys_ustdint_h.uint32_t) return sys_ustdint_h.uint32_t  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:2854
   with Import => True,
        Convention => C,
        External_Name => "k_event_test";
  ...
  --* @}
   type k_fifo is record
      u_queue : aliased k_queue;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:2875
   end record
   with Convention => C_Pass_By_Copy;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:2874
  ...
  --* @}
   type k_lifo is record
      u_queue : aliased k_queue;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:3116
   end record
   with Convention => C_Pass_By_Copy;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:3115
  ...
  --
   ...
   subtype stack_data_t is sys_ustdint_h.uintptr_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:3247

   type k_stack is record
      wait_q : aliased zephyr_kernel_structs_h.u_wait_q_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:3250
      lock : aliased zephyr_spinlock_h.k_spinlock;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:3251
      base : access stack_data_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:3252
      next : access stack_data_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:3252
      top : access stack_data_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:3252
      flags : aliased sys_ustdint_h.uint8_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:3254
   end record
   with Convention => C_Pass_By_Copy;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:3249
  ...
  --
   ...
   procedure k_stack_init
     (stack : access k_stack;
      buffer : access stack_data_t;
      num_entries : sys_ustdint_h.uint32_t)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:3290
   with Import => True,
        Convention => C,
        External_Name => "k_stack_init";
  ...
  --
   ...
   function k_stack_cleanup (stack : access k_stack) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:3322
   with Import => True,
        Convention => C,
        External_Name => "k_stack_cleanup";
  ...
  --
   ...
   --JGR k_sys_work_q : aliased k_work_q  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:3388
   --JGR with Import => True,
   --JGR      Convention => C,
   --JGR      External_Name => "k_sys_work_q";
  ...
  --* Mutex wait queue
   type k_mutex is record
      wait_q : aliased zephyr_kernel_structs_h.u_wait_q_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:3406
      owner : access zephyr_kernel_thread_h.k_thread;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:3408
      lock_count : aliased sys_ustdint_h.uint32_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:3411
      owner_orig_prio : aliased int;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:3414
   end record
   with Convention => C_Pass_By_Copy;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:3404
  ...
  --
   ...
   type k_condvar is record
      wait_q : aliased zephyr_kernel_structs_h.u_wait_q_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:3517
   end record
   with Convention => C_Pass_By_Copy;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:3516
  ...
  --
   ...
   type k_sem is record
      wait_q : aliased zephyr_kernel_structs_h.u_wait_q_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:3613
      count : aliased unsigned;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:3614
      limit : aliased unsigned;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:3615
      poll_events : aliased zephyr_sys_dlist_h.sys_dlist_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:3617
   end record
   with Convention => C_Pass_By_Copy;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:3609
  ...
  --
   ...
   function z_impl_k_sem_count_get (sem : access k_sem) return unsigned  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:3728
   with Import => True,
        Convention => C,
        External_Name => "z_impl_k_sem_count_get";
  ...
  -- Node in IPI work queue
  -- Function to execute on target CPU
  -- Event to signal when processed
  -- Bitmask of targeted CPUs
  --* INTERNAL_HIDDEN @endcond
  --*
  ...
  --
   ...
   type k_work;
   type k_work_handler_t is access procedure (arg1 : access k_work)
   with Convention => C;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:3873
  ...
  --
   ...
   procedure k_work_init (work : access k_work; handler : k_work_handler_t)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:3888
   with Import => True,
        Convention => C,
        External_Name => "k_work_init";
  ...
  --
   ...
   function k_work_busy_get (work : access constant k_work) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:3905
   with Import => True,
        Convention => C,
        External_Name => "k_work_busy_get";
  ...
  --
   ...
   type k_work_q;
   function k_work_submit_to_queue (queue : access k_work_q; work : access k_work) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:3942
   with Import => True,
        Convention => C,
        External_Name => "k_work_submit_to_queue";
  ...
  --
   ...
   function k_work_submit (work : access k_work) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:3953
   with Import => True,
        Convention => C,
        External_Name => "k_work_submit";
  ...
  --
   ...
   type k_work_sync;
   function k_work_flush (work : access k_work; sync : access k_work_sync) return Extensions.bool  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:3979
   with Import => True,
        Convention => C,
        External_Name => "k_work_flush";
  ...
  --
   ...
   function k_work_cancel (work : access k_work) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4001
   with Import => True,
        Convention => C,
        External_Name => "k_work_cancel";
  ...
  --
   ...
   function k_work_cancel_sync (work : access k_work; sync : access k_work_sync) return Extensions.bool  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4033
   with Import => True,
        Convention => C,
        External_Name => "k_work_cancel_sync";
  ...
  --
   ...
   procedure k_work_queue_init (queue : access k_work_q)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4044
   with Import => True,
        Convention => C,
        External_Name => "k_work_queue_init";
  ...
  --
   ...
   type k_work_queue_config;
   procedure k_work_queue_start
     (queue : access k_work_q;
      stack : access zephyr_kernel_thread_stack_h.z_thread_stack_element;
      stack_size : stddef_h.size_t;
      prio : int;
      cfg : access constant k_work_queue_config)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4065
   with Import => True,
        Convention => C,
        External_Name => "k_work_queue_start";
  ...
  --
   ...
   procedure k_work_queue_run (queue : access k_work_q; cfg : access constant k_work_queue_config)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4079
   with Import => True,
        Convention => C,
        External_Name => "k_work_queue_run";
  ...
  --
   ...
   function k_work_queue_drain (queue : access k_work_q; plug : Extensions.bool) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4115
   with Import => True,
        Convention => C,
        External_Name => "k_work_queue_drain";
  ...
  --
   ...
   function k_work_queue_unplug (queue : access k_work_q) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4130
   with Import => True,
        Convention => C,
        External_Name => "k_work_queue_unplug";
  ...
  --
   ...
   function k_work_queue_stop (queue : access k_work_q; timeout : zephyr_sys_clock_h.k_timeout_t) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4147
   with Import => True,
        Convention => C,
        External_Name => "k_work_queue_stop";
  ...
  --
   ...
   type k_work_delayable;
   procedure k_work_init_delayable (dwork : access k_work_delayable; handler : k_work_handler_t)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4162
   with Import => True,
        Convention => C,
        External_Name => "k_work_init_delayable";
  ...
  --
   ...
   function k_work_delayable_busy_get (dwork : access constant k_work_delayable) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4192
   with Import => True,
        Convention => C,
        External_Name => "k_work_delayable_busy_get";
  ...
  --
   ...
   function k_work_schedule_for_queue
     (queue : access k_work_q;
      dwork : access k_work_delayable;
      c_delay : zephyr_sys_clock_h.k_timeout_t) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4270
   with Import => True,
        Convention => C,
        External_Name => "k_work_schedule_for_queue";
  ...
  --
   ...
   function k_work_schedule (dwork : access k_work_delayable; c_delay : zephyr_sys_clock_h.k_timeout_t) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4287
   with Import => True,
        Convention => C,
        External_Name => "k_work_schedule";
  ...
  --
   ...
   function k_work_reschedule_for_queue
     (queue : access k_work_q;
      dwork : access k_work_delayable;
      c_delay : zephyr_sys_clock_h.k_timeout_t) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4325
   with Import => True,
        Convention => C,
        External_Name => "k_work_reschedule_for_queue";
  ...
  --
   ...
   function k_work_reschedule (dwork : access k_work_delayable; c_delay : zephyr_sys_clock_h.k_timeout_t) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4341
   with Import => True,
        Convention => C,
        External_Name => "k_work_reschedule";
  ...
  --
   ...
   function k_work_flush_delayable (dwork : access k_work_delayable; sync : access k_work_sync) return Extensions.bool  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4368
   with Import => True,
        Convention => C,
        External_Name => "k_work_flush_delayable";
  ...
  --
   ...
   function k_work_cancel_delayable (dwork : access k_work_delayable) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4391
   with Import => True,
        Convention => C,
        External_Name => "k_work_cancel_delayable";
  ...
  --
   ...
   function k_work_cancel_delayable_sync (dwork : access k_work_delayable; sync : access k_work_sync) return Extensions.bool  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4421
   with Import => True,
        Convention => C,
        External_Name => "k_work_cancel_delayable_sync";
  ...
  -- Node to link into k_work_q pending list.
   type k_work is record
      node : aliased zephyr_sys_slist_h.sys_snode_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4511
      handler : k_work_handler_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4514
      queue : access k_work_q;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4517
      flags : aliased sys_ustdint_h.uint32_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4525
   end record
   with Convention => C_Pass_By_Copy;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4505
  ...
  -- The work item.
   type k_work_delayable is record
      work : aliased k_work;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4535
      timeout : aliased zephyr_kernel_structs_h.u_timeout;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4538
      queue : access k_work_q;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4541
   end record
   with Convention => C_Pass_By_Copy;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4533
  ...
  --
   ...
   type z_work_flusher is record
      work : aliased k_work;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4583
      sem : aliased k_sem;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4584
   end record
   with Convention => C_Pass_By_Copy;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4582
  ...
  --
   ...
   type z_work_canceller is record
      node : aliased zephyr_sys_slist_h.sys_snode_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4594
      work : access k_work;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4595
      sem : aliased k_sem;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4596
   end record
   with Convention => C_Pass_By_Copy;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4593
  ...
  --
   ...
   type anon_union2614 (discr : unsigned := 0) is record
      case discr is
         when 0 =>
            flusher : aliased z_work_flusher;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4618
         when others =>
            canceller : aliased z_work_canceller;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4619
      end case;
   end record
   with Convention => C_Pass_By_Copy,
        Unchecked_Union => True;
   type k_work_sync is record
      anon9077 : aliased anon_union2614;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4620
   end record
   with Convention => C_Pass_By_Copy;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4616
  ...
  --
   ...
   type k_work_queue_config is record
      name : Interfaces.C.Strings.chars_ptr;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4634
      no_yield : aliased Extensions.bool;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4648
      essential : aliased Extensions.bool;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4653
      work_timeout_ms : aliased sys_ustdint_h.uint32_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4663
   end record
   with Convention => C_Pass_By_Copy;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4629
  ...
  -- The thread that animates the work.
   type k_work_q is record
      thread : aliased zephyr_kernel_thread_h.k_thread;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4669
      thread_id : zephyr_kernel_thread_h.k_tid_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4674
      pending : aliased zephyr_sys_slist_h.sys_slist_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4681
      notifyq : aliased zephyr_kernel_structs_h.u_wait_q_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4684
      drainq : aliased zephyr_kernel_structs_h.u_wait_q_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4687
      flags : aliased sys_ustdint_h.uint32_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4690
   end record
   with Convention => C_Pass_By_Copy;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4667
  ...
  -- Provide the implementation for inline functions declared above
   function k_work_is_pending (work : access constant k_work) return Extensions.bool  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4701
   with Import => True,
        Convention => C,
        External_Name => "k_work_is_pending";

   function k_work_delayable_from_work (work : access k_work) return access k_work_delayable  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4707
   with Import => True,
        Convention => C,
        External_Name => "k_work_delayable_from_work";

   function k_work_delayable_is_pending (dwork : access constant k_work_delayable) return Extensions.bool  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4712
   with Import => True,
        Convention => C,
        External_Name => "k_work_delayable_is_pending";

   function k_work_delayable_expires_get (dwork : access constant k_work_delayable) return zephyr_sys_clock_h.k_ticks_t  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4718
   with Import => True,
        Convention => C,
        External_Name => "k_work_delayable_expires_get";

   function k_work_delayable_remaining_get (dwork : access constant k_work_delayable) return zephyr_sys_clock_h.k_ticks_t  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4724
   with Import => True,
        Convention => C,
        External_Name => "k_work_delayable_remaining_get";

   function k_work_queue_thread_get (queue : access k_work_q) return zephyr_kernel_thread_h.k_tid_t  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4730
   with Import => True,
        Convention => C,
        External_Name => "k_work_queue_thread_get";
  ...
  --
   ...
   type k_work_user;
   type k_work_user_handler_t is access procedure (arg1 : access k_work_user)
   with Convention => C;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4753

  --*
  -- * @cond INTERNAL_HIDDEN
  --

   type k_work_user_q is record
      queue : aliased k_queue;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4760
      thread : aliased zephyr_kernel_thread_h.k_thread;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4761
   end record
   with Convention => C_Pass_By_Copy;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4759

  -- Work item pending state
  -- Used by k_queue implementation.
   type k_work_user is record
      u_reserved : System.Address;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4769
      handler : k_work_user_handler_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4770
      flags : aliased zephyr_sys_atomic_types_h.atomic_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4771
   end record
   with Convention => C_Pass_By_Copy;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4768
  ...
  --
   ...
   procedure k_work_user_init (work : access k_work_user; handler : k_work_user_handler_t)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4812
   with Import => True,
        Convention => C,
        External_Name => "k_work_user_init";
  ...
  --
   ...
   function k_work_user_is_pending (work : access k_work_user) return Extensions.bool  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4834
   with Import => True,
        Convention => C,
        External_Name => "k_work_user_is_pending";
  ...
  --
   ...
   function k_work_user_submit_to_queue (work_q : access k_work_user_q; work : access k_work_user) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4857
   with Import => True,
        Convention => C,
        External_Name => "k_work_user_submit_to_queue";
  ...
  --
   ...
   procedure k_work_user_queue_start
     (work_q : access k_work_user_q;
      stack : access zephyr_kernel_thread_stack_h.z_thread_stack_element;
      stack_size : stddef_h.size_t;
      prio : int;
      name : Interfaces.C.Strings.chars_ptr)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4897
   with Import => True,
        Convention => C,
        External_Name => "k_work_user_queue_start";
  ...
  --
   ...
   function k_work_user_queue_thread_get (work_q : access k_work_user_q) return zephyr_kernel_thread_h.k_tid_t  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4912
   with Import => True,
        Convention => C,
        External_Name => "k_work_user_queue_thread_get";
  ...
  --
   ...
   type k_work_poll is record
      work : aliased k_work;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4924
      workq : access k_work_q;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4925
      poller : aliased zephyr_kernel_thread_h.z_poller;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4926
      events : access k_poll_event;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4927
      num_events : aliased int;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4928
      real_handler : k_work_handler_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4929
      timeout : aliased zephyr_kernel_structs_h.u_timeout;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4930
      poll_result : aliased int;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4931
   end record
   with Convention => C_Pass_By_Copy;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4923
  ...
  --
   ...
   procedure k_work_poll_init (work : access k_work_poll; handler : k_work_handler_t)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:4966
   with Import => True,
        Convention => C,
        External_Name => "k_work_poll_init";
  ...
  --
   ...
   function k_work_poll_submit_to_queue
     (work_q : access k_work_q;
      work : access k_work_poll;
      events : access k_poll_event;
      num_events : int;
      timeout : zephyr_sys_clock_h.k_timeout_t) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5003
   with Import => True,
        Convention => C,
        External_Name => "k_work_poll_submit_to_queue";
  ...
  --
   ...
   function k_work_poll_submit
     (work : access k_work_poll;
      events : access k_poll_event;
      num_events : int;
      timeout : zephyr_sys_clock_h.k_timeout_t) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5040
   with Import => True,
        Convention => C,
        External_Name => "k_work_poll_submit";
  ...
  --
   ...
   function k_work_poll_cancel (work : access k_work_poll) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5059
   with Import => True,
        Convention => C,
        External_Name => "k_work_poll_cancel";
  ...
  --* Message queue wait queue
   type k_msgq is record
      wait_q : aliased zephyr_kernel_structs_h.u_wait_q_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5074
      lock : aliased zephyr_spinlock_h.k_spinlock;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5076
      msg_size : aliased stddef_h.size_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5078
      max_msgs : aliased sys_ustdint_h.uint32_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5080
      buffer_start : Interfaces.C.Strings.chars_ptr;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5082
      buffer_end : Interfaces.C.Strings.chars_ptr;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5084
      read_ptr : Interfaces.C.Strings.chars_ptr;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5086
      write_ptr : Interfaces.C.Strings.chars_ptr;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5088
      used_msgs : aliased sys_ustdint_h.uint32_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5090
      poll_events : aliased zephyr_sys_dlist_h.sys_dlist_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5092
      flags : aliased sys_ustdint_h.uint8_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5095
   end record
   with Convention => C_Pass_By_Copy;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5072
  ...
  --* Message Size
   type k_msgq_attrs is record
      msg_size : aliased stddef_h.size_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5135
      max_msgs : aliased sys_ustdint_h.uint32_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5137
      used_msgs : aliased sys_ustdint_h.uint32_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5139
   end record
   with Convention => C_Pass_By_Copy;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5133
  ...
  --
   ...
   procedure k_msgq_init
     (msgq : access k_msgq;
      buffer : Interfaces.C.Strings.chars_ptr;
      msg_size : stddef_h.size_t;
      max_msgs : sys_ustdint_h.uint32_t)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5182
   with Import => True,
        Convention => C,
        External_Name => "k_msgq_init";
  ...
  --
   ...
   function k_msgq_cleanup (msgq : access k_msgq) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5217
   with Import => True,
        Convention => C,
        External_Name => "k_msgq_cleanup";
  ...
  --
   ...
   function z_impl_k_msgq_num_free_get (msgq : access k_msgq) return sys_ustdint_h.uint32_t  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5358
   with Import => True,
        Convention => C,
        External_Name => "z_impl_k_msgq_num_free_get";
  ...
  --
   ...
   function z_impl_k_msgq_num_used_get (msgq : access k_msgq) return sys_ustdint_h.uint32_t  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5374
   with Import => True,
        Convention => C,
        External_Name => "z_impl_k_msgq_num_used_get";
  ...
  --* size of message (in bytes)
   type k_mbox_msg is record
      size : aliased stddef_h.size_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5393
      info : aliased sys_ustdint_h.uint32_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5395
      tx_data : System.Address;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5397
      rx_source_thread : zephyr_kernel_thread_h.k_tid_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5399
      tx_target_thread : zephyr_kernel_thread_h.k_tid_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5401
      u_syncing_thread : zephyr_kernel_thread_h.k_tid_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5403
      u_async_sem : access k_sem;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5406
   end record
   with Convention => C_Pass_By_Copy;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5391
  ...
  --* Transmit messages queue
   type k_mbox is record
      tx_msg_queue : aliased zephyr_kernel_structs_h.u_wait_q_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5415
      rx_msg_queue : aliased zephyr_kernel_structs_h.u_wait_q_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5417
      lock : aliased zephyr_spinlock_h.k_spinlock;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5418
   end record
   with Convention => C_Pass_By_Copy;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5413
  ...
  --
   ...
   procedure k_mbox_init (mbox : access k_mbox)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5460
   with Import => True,
        Convention => C,
        External_Name => "k_mbox_init";
  ...
  --
   ...
   function k_mbox_put
     (mbox : access k_mbox;
      tx_msg : access k_mbox_msg;
      timeout : zephyr_sys_clock_h.k_timeout_t) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5481
   with Import => True,
        Convention => C,
        External_Name => "k_mbox_put";
  ...
  --
   ...
   procedure k_mbox_async_put
     (mbox : access k_mbox;
      tx_msg : access k_mbox_msg;
      sem : access k_sem)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5497
   with Import => True,
        Convention => C,
        External_Name => "k_mbox_async_put";
  ...
  --
   ...
   function k_mbox_get
     (mbox : access k_mbox;
      rx_msg : access k_mbox_msg;
      buffer : System.Address;
      timeout : zephyr_sys_clock_h.k_timeout_t) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5517
   with Import => True,
        Convention => C,
        External_Name => "k_mbox_get";
  ...
  --
   ...
   procedure k_mbox_data_get (rx_msg : access k_mbox_msg; buffer : System.Address)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5533
   with Import => True,
        Convention => C,
        External_Name => "k_mbox_data_get";
  ...
  --
   ...
   subtype pipe_flags is unsigned;
   pipe_flags_PIPE_FLAG_OPEN : constant pipe_flags := 1;
   pipe_flags_PIPE_FLAG_RESET : constant pipe_flags := 2;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5554

   type k_pipe is record
      waiting : aliased stddef_h.size_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5560
      buf : aliased zephyr_sys_ring_buffer_h.ring_buf;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5561
      lock : aliased zephyr_spinlock_h.k_spinlock;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5562
      data : aliased zephyr_kernel_structs_h.u_wait_q_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5563
      space : aliased zephyr_kernel_structs_h.u_wait_q_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5564
      flags : aliased sys_ustdint_h.uint8_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5565
      poll_events : aliased zephyr_sys_dlist_h.sys_dlist_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5567
   end record
   with Convention => C_Pass_By_Copy;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5559
  ...
  --
   ...
   type k_mem_slab_info is record
      num_blocks : aliased sys_ustdint_h.uint32_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5673
      block_size : aliased stddef_h.size_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5674
      num_used : aliased sys_ustdint_h.uint32_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5675
   end record
   with Convention => C_Pass_By_Copy;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5672

   type k_mem_slab is record
      wait_q : aliased zephyr_kernel_structs_h.u_wait_q_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5682
      lock : aliased zephyr_spinlock_h.k_spinlock;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5683
      buffer : Interfaces.C.Strings.chars_ptr;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5684
      free_list : Interfaces.C.Strings.chars_ptr;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5685
      info : aliased k_mem_slab_info;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5686
   end record
   with Convention => C_Pass_By_Copy;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5681
  ...
  --
   ...
   function k_mem_slab_init
     (slab : access k_mem_slab;
      buffer : System.Address;
      block_size : stddef_h.size_t;
      num_blocks : sys_ustdint_h.uint32_t) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5844
   with Import => True,
        Convention => C,
        External_Name => "k_mem_slab_init";
  ...
  --
   ...
   function k_mem_slab_alloc
     (slab : access k_mem_slab;
      mem : System.Address;
      timeout : zephyr_sys_clock_h.k_timeout_t) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5869
   with Import => True,
        Convention => C,
        External_Name => "k_mem_slab_alloc";
  ...
  --
   ...
   procedure k_mem_slab_free (slab : access k_mem_slab; mem : System.Address)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5883
   with Import => True,
        Convention => C,
        External_Name => "k_mem_slab_free";
  ...
  --
   ...
   function k_mem_slab_num_used_get (slab : access k_mem_slab) return sys_ustdint_h.uint32_t  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5897
   with Import => True,
        Convention => C,
        External_Name => "k_mem_slab_num_used_get";
  ...
  --
   ...
   function k_mem_slab_max_used_get (slab : access k_mem_slab) return sys_ustdint_h.uint32_t  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5914
   with Import => True,
        Convention => C,
        External_Name => "k_mem_slab_max_used_get";
  ...
  --
   ...
   function k_mem_slab_num_free_get (slab : access k_mem_slab) return sys_ustdint_h.uint32_t  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5936
   with Import => True,
        Convention => C,
        External_Name => "k_mem_slab_num_free_get";
  ...
  --
   ...
   function k_mem_slab_runtime_stats_get (slab : access k_mem_slab; stats : access zephyr_sys_mem_stats_h.sys_memory_stats) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5955
   with Import => True,
        Convention => C,
        External_Name => "k_mem_slab_runtime_stats_get";
  ...
  --
   ...
   function k_mem_slab_runtime_stats_reset_max (slab : access k_mem_slab) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5970
   with Import => True,
        Convention => C,
        External_Name => "k_mem_slab_runtime_stats_reset_max";
  ...
  -- kernel synchronized heap struct
   type k_heap is record
      heap : aliased zephyr_sys_sys_heap_h.sys_heap;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5982
      wait_q : aliased zephyr_kernel_structs_h.u_wait_q_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5983
      lock : aliased zephyr_spinlock_h.k_spinlock;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5984
   end record
   with Convention => C_Pass_By_Copy;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:5981
  ...
  --
   ...
   procedure k_heap_init
     (h : access k_heap;
      mem : System.Address;
      bytes : stddef_h.size_t)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6000
   with Import => True,
        Convention => C,
        External_Name => "k_heap_init";
  ...
  --
   ...
   function k_heap_aligned_alloc
     (h : access k_heap;
      ...
      timeout : zephyr_sys_clock_h.k_timeout_t) return System.Address  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6023
   with Import => True,
        Convention => C,
        External_Name => "k_heap_aligned_alloc";
  ...
  --
   ...
   function k_heap_alloc
     (h : access k_heap;
      bytes : stddef_h.size_t;
      timeout : zephyr_sys_clock_h.k_timeout_t) return System.Address  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6047
   with Import => True,
        Convention => C,
        External_Name => "k_heap_alloc";
  ...
  --
   ...
   function k_heap_calloc
     (h : access k_heap;
      num : stddef_h.size_t;
      size : stddef_h.size_t;
      timeout : zephyr_sys_clock_h.k_timeout_t) return System.Address  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6072
   with Import => True,
        Convention => C,
        External_Name => "k_heap_calloc";
  ...
  --
   ...
   function k_heap_realloc
     (h : access k_heap;
      ptr : System.Address;
      bytes : stddef_h.size_t;
      timeout : zephyr_sys_clock_h.k_timeout_t) return System.Address  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6098
   with Import => True,
        Convention => C,
        External_Name => "k_heap_realloc";
  ...
  --
   ...
   procedure k_heap_free (h : access k_heap; mem : System.Address)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6111
   with Import => True,
        Convention => C,
        External_Name => "k_heap_free";
  ...
  --
   ...
   function k_heap_array_get (heap : System.Address) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6193
   with Import => True,
        Convention => C,
        External_Name => "k_heap_array_get";
  ...
  --
   ...
   function k_aligned_alloc (align : stddef_h.size_t; size : stddef_h.size_t) return System.Address  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6224
   with Import => True,
        Convention => C,
        External_Name => "k_aligned_alloc";
  ...
  --
   ...
   function k_malloc (size : stddef_h.size_t) return System.Address  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6237
   with Import => True,
        Convention => C,
        External_Name => "k_malloc";
  ...
  --
   ...
   procedure k_free (ptr : System.Address)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6249
   with Import => True,
        Convention => C,
        External_Name => "k_free";
  ...
  --
   ...
   function k_calloc (nmemb : stddef_h.size_t; size : stddef_h.size_t) return System.Address  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6262
   with Import => True,
        Convention => C,
        External_Name => "k_calloc";
  ...
  --
   ...
   function k_realloc (ptr : System.Address; size : stddef_h.size_t) return System.Address  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6281
   with Import => True,
        Convention => C,
        External_Name => "k_realloc";

  --* @}
  -- polling API - PRIVATE
  -- private - types bit positions
   type u_poll_types_bits is
     (u_POLL_TYPE_IGNORE,
      u_POLL_TYPE_SIGNAL,
      u_POLL_TYPE_SEM_AVAILABLE,
      u_POLL_TYPE_DATA_AVAILABLE,
      u_POLL_TYPE_MSGQ_DATA_AVAILABLE,
      u_POLL_TYPE_PIPE_DATA_AVAILABLE,
      u_POLL_NUM_TYPES)
   with Convention => C;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6294
  ...
  -- private - states bit positions
   type u_poll_states_bits is
     (u_POLL_STATE_NOT_READY,
      u_POLL_STATE_SIGNALED,
      u_POLL_STATE_SEM_AVAILABLE,
      u_POLL_STATE_DATA_AVAILABLE,
      u_POLL_STATE_CANCELLED,
      u_POLL_STATE_MSGQ_DATA_AVAILABLE,
      u_POLL_STATE_PIPE_DATA_AVAILABLE,
      u_POLL_NUM_STATES)
   with Convention => C;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6319
  ...
  -- public - polling modes
   type k_poll_modes is
     (K_POLL_MODE_NOTIFY_ONLY,
      K_POLL_NUM_MODES)
   with Convention => C;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6377

  -- polling thread does not take ownership of objects when available
  -- public - values for k_poll_event.state bitfield
  -- public - poll signal object
  --* PRIVATE - DO NOT TOUCH
   type k_poll_signal is record
      poll_events : aliased zephyr_sys_dlist_h.sys_dlist_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6397
      signaled : aliased unsigned;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6403
      result : aliased int;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6406
   end record
   with Convention => C_Pass_By_Copy;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6395
  ...
  --
   ...
   type anon_union2721 (discr : unsigned := 0) is record
      case discr is
         when 0 =>
            obj : System.Address;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6446
         when 1 =>
            typed_K_POLL_TYPE_IGNORE : System.Address;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6446
         when 2 =>
            signal : access k_poll_signal;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6447
         when 3 =>
            typed_K_POLL_TYPE_SIGNAL : access k_poll_signal;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6447
         when 4 =>
            sem : access k_sem;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6448
         when 5 =>
            typed_K_POLL_TYPE_SEM_AVAILABLE : access k_sem;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6448
         when 6 =>
            fifo : access k_fifo;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6449
         when 7 =>
            typed_K_POLL_TYPE_FIFO_DATA_AVAILABLE : access k_fifo;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6449
         when 8 =>
            queue : access k_queue;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6450
         when 9 =>
            typed_K_POLL_TYPE_DATA_AVAILABLE : access k_queue;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6450
         when 10 =>
            msgq : access k_msgq;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6451
         when 11 =>
            typed_K_POLL_TYPE_MSGQ_DATA_AVAILABLE : access k_msgq;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6451
         when 12 =>
            pipe : access k_pipe;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6452
         when others =>
            typed_K_POLL_TYPE_PIPE_DATA_AVAILABLE : access k_pipe;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6452
      end case;
   end record
   with Convention => C_Pass_By_Copy,
        Unchecked_Union => True;
   type k_poll_event is record
      u_node : aliased zephyr_sys_dlist_h.sys_dnode_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6421
      poller : access zephyr_kernel_thread_h.z_poller;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6424
      tag : aliased unsigned_char;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6427
      c_type : Extensions.Unsigned_6;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6430
      state : Extensions.Unsigned_7;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6433
      mode : Extensions.Unsigned_1;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6436
      unused : Extensions.Unsigned_10;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6439
      anon9403 : aliased anon_union2721;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6453
   end record
   with Convention => C_Pass_By_Copy,
        --JGR Pack => True,
        Alignment => 4;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6419
  ...
  --
   ...
   procedure k_poll_event_init
     (event : access k_poll_event;
      c_type : sys_ustdint_h.uint32_t;
      mode : int;
      obj : System.Address)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6496
   with Import => True,
        Convention => C,
        External_Name => "k_poll_event_init";
  ...
  --
   ...
   procedure k_cpu_idle  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6621
   with Import => True,
        Convention => C,
        External_Name => "k_cpu_idle";
  ...
  --
   ...
   procedure k_cpu_atomic_idle (key : unsigned)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6640
   with Import => True,
        Convention => C,
        External_Name => "k_cpu_atomic_idle";
  ...
  --
   ...
   procedure z_timer_expiration_handler (timeout : access zephyr_kernel_structs_h.u_timeout)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6715
   with Import => True,
        Convention => C,
        External_Name => "z_timer_expiration_handler";
  ...
  --
   ...
   function k_thread_runtime_stats_get (thread : zephyr_kernel_thread_h.k_tid_t; stats : access zephyr_kernel_thread_h.k_thread_runtime_stats) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6810
   with Import => True,
        Convention => C,
        External_Name => "k_thread_runtime_stats_get";
  ...
  --
   ...
   function k_thread_runtime_stats_all_get (stats : access zephyr_kernel_thread_h.k_thread_runtime_stats) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6819
   with Import => True,
        Convention => C,
        External_Name => "k_thread_runtime_stats_all_get";
  ...
  --
   ...
   function k_thread_runtime_stats_cpu_get (cpu : int; stats : access zephyr_kernel_thread_h.k_thread_runtime_stats) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6828
   with Import => True,
        Convention => C,
        External_Name => "k_thread_runtime_stats_cpu_get";
  ...
  --
   ...
   function k_thread_runtime_stats_enable (thread : zephyr_kernel_thread_h.k_tid_t) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6839
   with Import => True,
        Convention => C,
        External_Name => "k_thread_runtime_stats_enable";
  ...
  --
   ...
   function k_thread_runtime_stats_disable (thread : zephyr_kernel_thread_h.k_tid_t) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6850
   with Import => True,
        Convention => C,
        External_Name => "k_thread_runtime_stats_disable";
  ...
  --
   ...
   procedure k_sys_runtime_stats_enable  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6859
   with Import => True,
        Convention => C,
        External_Name => "k_sys_runtime_stats_enable";
  ...
  --
   ...
   procedure k_sys_runtime_stats_disable  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel.h:6868
   with Import => True,
        Convention => C,
        External_Name => "k_sys_runtime_stats_disable";
