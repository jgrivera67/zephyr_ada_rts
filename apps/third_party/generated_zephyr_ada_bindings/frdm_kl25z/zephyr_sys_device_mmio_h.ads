...
package zephyr_sys_device_mmio_h is
   ...
   --    return DEVICE_MMIO_ROM_PTR(dev).addr;
   ...
   --    return (DEVICE_MMIO_NAMED_ROM_PTR((dev), name)).addr;
   ...
   --    __pinned_rodata const struct z_device_mmio_rom Z_TOPLEVEL_ROM_NAME(name) := Z_DEVICE_MMIO_ROM_INITIALIZER(node_id)
   ...
   --    __pinned_rodata static const struct z_device_mmio_rom Z_TOPLEVEL_ROM_NAME(name) := Z_DEVICE_MMIO_ROM_INITIALIZER(node_id)
   ...
   --    return (mm_reg_t)Z_TOPLEVEL_ROM_NAME(name).addr;
  ...
  --* MMIO linear address  
   type z_device_mmio_rom is record
      addr : aliased zephyr_sys_sys_io_h.mm_reg_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/sys/device_mmio.h:122
   end record
   with Convention => C_Pass_By_Copy;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/sys/device_mmio.h:120

   procedure device_map
     (virt_addr : access zephyr_sys_sys_io_h.mm_reg_t;
      phys_addr : sys_ustdint_h.uintptr_t;
      size : stddef_h.size_t;
      flags : sys_ustdint_h.uint32_t)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/sys/device_mmio.h:136
   with Import => True, 
        Convention => C, 
