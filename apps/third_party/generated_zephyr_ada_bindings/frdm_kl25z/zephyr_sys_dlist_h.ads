...
package zephyr_sys_dlist_h is
  ...
  -- ptr to tail of list (sys_dlist_t)  
   type u_dnode;
   type anon_union1123 (discr : unsigned := 0) is record
      case discr is
         when 0 =>
   ...
   type anon_union1125 (discr : unsigned := 0) is record
      case discr is
         when 0 =>
   ...
   type u_dnode is record
      anon4989 : aliased anon_union1123;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/sys/dlist.h:40
      anon4993 : aliased anon_union1125;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/sys/dlist.h:44
   end record
