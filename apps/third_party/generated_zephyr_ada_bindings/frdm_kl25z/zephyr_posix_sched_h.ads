...
package zephyr_posix_sched_h is
  ...
  --  
   ...
   function sched_get_priority_min (policy : int) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/posix/sched.h:45
   with Import => True, 
        Convention => C, 
        External_Name => "sched_get_priority_min";

   function sched_get_priority_max (policy : int) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/posix/sched.h:46
   with Import => True, 
        Convention => C, 
        External_Name => "sched_get_priority_max";

   function sched_getparam (pid : zephyr_posix_posix_types_h.pid_t; param : access sched_param) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/posix/sched.h:48
   with Import => True, 
        Convention => C, 
        External_Name => "sched_getparam";

   function sched_getscheduler (pid : zephyr_posix_posix_types_h.pid_t) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/posix/sched.h:49
   with Import => True, 
        Convention => C, 
        External_Name => "sched_getscheduler";

   function sched_setparam (pid : zephyr_posix_posix_types_h.pid_t; param : access constant sched_param) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/posix/sched.h:51
   with Import => True, 
        Convention => C, 
        External_Name => "sched_setparam";

   function sched_setscheduler
     (pid : zephyr_posix_posix_types_h.pid_t;
      policy : int;
      param : access constant sched_param) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/posix/sched.h:52
   with Import => True, 
        Convention => C, 
        External_Name => "sched_setscheduler";

   function sched_rr_get_interval (pid : zephyr_posix_posix_types_h.pid_t; interval : access sys_utimespec_h.timespec) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/posix/sched.h:53
   with Import => True, 
        Convention => C, 
