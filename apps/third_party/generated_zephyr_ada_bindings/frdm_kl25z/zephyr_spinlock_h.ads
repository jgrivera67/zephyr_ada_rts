...
package zephyr_spinlock_h is
  ...
  --  
   ...
   function k_spin_lock (l : access k_spinlock) return k_spinlock_key_t  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/spinlock.h:185
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function k_spin_trylock (l : access k_spinlock; k : access k_spinlock_key_t) return int  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/spinlock.h:233
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   procedure k_spin_unlock (l : access k_spinlock; key : k_spinlock_key_t)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/spinlock.h:303
   with Import => True, 
        Convention => C, 
  ...
  -- Internal function: releases the lock, but leaves local interrupts disabled  
   procedure k_spin_release (l : access k_spinlock)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/spinlock.h:362
   with Import => True, 
        Convention => C, 
        External_Name => "k_spin_release";

   procedure z_spin_onexit (k : access k_spinlock_key_t)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/spinlock.h:378
   with Import => True, 
        Convention => C, 
