...
package zephyr_kernel_thread_stack_h is
   ...
   --  unsupported macro: K_KERNEL_STACK_RESERVED ((size_t)ARCH_KERNEL_STACK_RESERVED)
   --  arg-macro: function Z_KERNEL_STACK_SIZE_ADJUST (size)
   --    return ROUND_UP(size, ARCH_STACK_PTR_ALIGN) + K_KERNEL_STACK_RESERVED;
   --  unsupported macro: Z_KERNEL_STACK_OBJ_ALIGN ARCH_KERNEL_STACK_OBJ_ALIGN
  ...
  --* @}
   function K_KERNEL_STACK_BUFFER (sym : access z_thread_stack_element) return Interfaces.C.Strings.chars_ptr  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/kernel/thread_stack.h:286
   with Import => True,
        Convention => C,
