...
package zephyr_pm_state_h is
  ...
  --  
   ...
   function pm_state_cpu_get_all (cpu : sys_ustdint_h.uint8_t; states : System.Address) return sys_ustdint_h.uint8_t  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/pm/state.h:391
   with Import => True, 
        Convention => C, 
   ...
   function pm_state_get
     (cpu : sys_ustdint_h.uint8_t;
      state : pm_state;
      substate_id : sys_ustdint_h.uint8_t) return access constant pm_state_info  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/pm/state.h:399
   with Import => True, 
        Convention => C, 
