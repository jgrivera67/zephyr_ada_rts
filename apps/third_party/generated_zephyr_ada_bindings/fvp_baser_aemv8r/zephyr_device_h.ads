...
package zephyr_device_h is
   ...
   --  arg-macro: procedure Z_DEVICE_EXPORT (node_id)
   --    EXPORT_GROUP_SYMBOL(DEVICE, DEVICE_DT_NAME_GET(node_id))
   --  arg-macro: procedure DEVICE_DEINIT_DEFINE (dev_id, name, init_fn, deinit_fn, pm, data, config, level, prio, api)
   --    Z_DEVICE_STATE_DEFINE(dev_id); Z_DEVICE_DEFINE(DT_INVALID_NODE, dev_id, name, init_fn, deinit_fn, 0, pm, data, config, level, prio, api, andZ_DEVICE_STATE_NAME(dev_id))
   --  arg-macro: procedure DEVICE_DEFINE (dev_id, name, init_fn, pm, data, config, level, prio, api)
   --    DEVICE_DEINIT_DEFINE(dev_id, name, init_fn, NULL, pm, data, config, level, prio, api)
   --  arg-macro: procedure DEVICE_DT_NAME (node_id)
   --    DT_PROP_OR(node_id, label, DT_NODE_FULL_NAME(node_id))
   --  unsupported macro: DEVICE_DT_DEINIT_DEFINE(node_id,init_fn,deinit_fn,pm,data,config,level,prio,api,...) Z_DEVICE_STATE_DEFINE(Z_DEVICE_DT_DEV_ID(node_id)); Z_DEVICE_DEFINE(node_id, Z_DEVICE_DT_DEV_ID(node_id), DEVICE_DT_NAME(node_id), init_fn, deinit_fn, Z_DEVICE_DT_FLAGS(node_id), pm, data, config, level, prio, api, &Z_DEVICE_STATE_NAME(Z_DEVICE_DT_DEV_ID(node_id)), __VA_ARGS__)
   --  unsupported macro: DEVICE_DT_DEFINE(node_id,init_fn,pm,data,config,level,prio,api,...) DEVICE_DT_DEINIT_DEFINE(node_id, init_fn, NULL, pm, data, config, level, prio, api, __VA_ARGS__)
   --  unsupported macro: DEVICE_DT_INST_DEINIT_DEFINE(inst,...) DEVICE_DT_DEINIT_DEFINE(DT_DRV_INST(inst), __VA_ARGS__)
   ...
   --  unsupported macro: DEVICE_FLAG_INIT_DEFERRED BIT(0)
   ...
   --  arg-macro: function Z_DEVICE_DT_FLAGS (node_id)
   --    return DT_PROP_OR(node_id, zephyr_deferred_init, 0) * DEVICE_FLAG_INIT_DEFERRED;
   --  arg-macro: procedure Z_DEVICE_INIT_SUB_PRIO (node_id)
   --    COND_CODE_1(DT_NODE_EXISTS(node_id), (DT_DEP_ORD_STR_SORTABLE(node_id)), (0))

   Z_DEVICE_MAX_NAME_LEN : constant := 48;  --  /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/device.h:1136
   ...
   --  arg-macro: procedure Z_DEVICE_OPS (init_fn_, deinit_fn_)
   --    { .init := (init_fn_), IF_ENABLED(CONFIG_DEVICE_DEINIT_SUPPORT, (.deinit := (deinit_fn_),)) }
   --  arg-macro: procedure Z_DEVICE_INIT (name_, init_fn_, deinit_fn_, flags_, pm_, data_, config_, api_, state_, deps_, node_id_, dev_id_)
   --    { .name := name_, .config := (config_), .api := (api_), .state := (state_), .data := (data_), .ops := Z_DEVICE_OPS(init_fn_, deinit_fn_), .flags := (flags_), IF_ENABLED(CONFIG_DEVICE_DEPS, (.deps := (deps_),)) IF_ENABLED(CONFIG_PM_DEVICE, Z_DEVICE_INIT_PM_BASE(pm_)) IF_ENABLED(CONFIG_DEVICE_DT_METADATA, (IF_ENABLED(DT_NODE_EXISTS(node_id_), (.dt_meta := andZ_DEVICE_DT_METADATA_NAME_GET( dev_id_),)))) }
   ...
   --  arg-macro: procedure Z_DEVICE_BASE_DEFINE (node_id, dev_id, name, init_fn, deinit_fn, flags, pm, data, config, level, prio, api, state, deps)
   --    COND_CODE_1(DT_NODE_EXISTS(node_id), (), (static)) COND_CODE_1(Z_DEVICE_IS_MUTABLE(node_id), (), (const)) STRUCT_SECTION_ITERABLE_NAMED_ALTERNATE( device, COND_CODE_1(Z_DEVICE_IS_MUTABLE(node_id), (device_mutable), (device)), Z_DEVICE_SECTION_NAME(level, prio), DEVICE_NAME_GET(dev_id)) := Z_DEVICE_INIT(name, init_fn, deinit_fn, flags, pm, data, config, api, state, deps, node_id, dev_id)
   --  unsupported macro: Z_DEVICE_CHECK_INIT_LEVEL(level) COND_CASE_1(Z_INIT_PRE_KERNEL_1_ ##level, (), Z_INIT_PRE_KERNEL_2_ ##level, (), Z_INIT_POST_KERNEL_ ##level, (), (ZERO_OR_COMPILE_ERROR(0)))
   --  arg-macro: procedure Z_DEVICE_INIT_ENTRY_DEFINE (node_id, dev_id, level, prio)
   --    Z_DEVICE_CHECK_INIT_LEVEL(level) static const Z_DECL_ALIGN(struct init_entry) __used __noasan Z_INIT_ENTRY_SECTION( level, prio, Z_DEVICE_INIT_SUB_PRIO(node_id)) Z_INIT_ENTRY_NAME(DEVICE_NAME_GET(dev_id)) := { .init_fn := NULL, .dev := (const struct device *)andDEVICE_NAME_GET(dev_id), }
   --  unsupported macro: Z_DEVICE_DEFINE(node_id,dev_id,name,init_fn,deinit_fn,flags,pm,data,config,level,prio,api,state,...) Z_DEVICE_NAME_CHECK(name); IF_ENABLED(CONFIG_DEVICE_DEPS, (Z_DEVICE_DEPS_DEFINE(node_id, dev_id, __VA_ARGS__);)) IF_ENABLED(CONFIG_DEVICE_DT_METADATA, (IF_ENABLED(DT_NODE_EXISTS(node_id), (Z_DEVICE_DT_METADATA_DEFINE(node_id, dev_id);)))) Z_DEVICE_BASE_DEFINE(node_id, dev_id, name, init_fn, deinit_fn, flags, pm, data, config, level, prio, api, state, Z_DEVICE_DEPS_NAME(dev_id)); Z_DEVICE_INIT_ENTRY_DEFINE(node_id, dev_id, level, prio); IF_ENABLED(CONFIG_LLEXT, (IF_ENABLED(DT_NODE_EXISTS(node_id), (Z_DEVICE_EXPORT(node_id);))))
  ...
  --	  
   ...
   type device_state is record
      init_res : aliased sys_ustdint_h.uint8_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/device.h:466
      initialized : aliased Extensions.bool;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/device.h:471
   end record
   with Convention => C_Pass_By_Copy;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/device.h:458
  ...
  --* Device flags  
   subtype device_flags_t is sys_ustdint_h.uint8_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/device.h:488
  ...
  --* Initialization function  
   type device;
   type device_ops is record
      init : access function (arg1 : access constant device) return int;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/device.h:503
   end record
   with Convention => C_Pass_By_Copy;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/device.h:501
  ...
  --* Name of the device instance  
   type device is record
      name : Interfaces.C.Strings.chars_ptr;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/device.h:515
      config : System.Address;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/device.h:517
      api : System.Address;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/device.h:519
      state : access device_state;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/device.h:521
      data : System.Address;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/device.h:523
      ops : aliased device_ops;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/device.h:525
      flags : aliased device_flags_t;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/device.h:527
   end record
   with Convention => C_Pass_By_Copy;  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/device.h:513
  ...
  --  
   ...
   function device_handle_get (dev : access constant device) return device_handle_t  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/device.h:563
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function device_from_handle (dev_handle : device_handle_t) return access constant device  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/device.h:587
   with Import => True, 
        Convention => C, 
  ...
  --  
   ...
   function z_device_get_all_static (devices : System.Address) return stddef_h.size_t  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/device.h:851
   with Import => True, 
        Convention => C, 
