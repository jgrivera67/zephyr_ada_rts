  ...
  --  
   ...
   procedure arch_stack_walk
     (callback_fn : stack_trace_callback_fn;
      ...
      esf : access constant zephyr_arch_riscv_exception_h.arch_esf)  -- /Users/jgrivera/my-projects/third-party/zephyrproject/zephyr/include/zephyr/arch/arch_interface.h:1295
   with Import => True, 
        Convention => C, 
